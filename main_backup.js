...
class DXBallGame {
  constructor() {
    ...
    for (let col = 0; col < 10; col++) {
      for (let row = 0; row < 5; row++) {
        //координата кирпича по x и y с отступами, чтобы при отрисовке кирпичи не накладывались друг на друга
  ...
  keyDownHandler(e) {
    //если нажата стрелка вправо, вправо на цифровой клавиатуре или "D"
    if (e.key == "ArrowRight" || e.key == "Right" || e.key == "D") {
      //переключаем состояние нажатия клавиши - платформа двигается
      this.paddle.rightPressed = true;
    }
    //если нажата стрелка влево, влево на цифровой клавиатуре или "A"
